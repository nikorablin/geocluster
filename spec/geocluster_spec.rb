...
describe Geocluster do
  describe '#cluster_coordinates' do
    specify 'Two coordinates that are nearby are clustered' do
      ...
      clusters.should eq [{:coordinates => [52.3941887, 13.072691000000003], :count => 3, :geohash => 'u33'}] # One cluster above those three coordinates, centered where most coordinates are
    end
    ...
    specify 'No nocleus clusters geographically centered' do
      ...
      clusters.should eq [{:coordinates=>[52.474657748317775, 13.310132265262823], :count=>3, :geohash => 'u33'}] # One cluster above those three coordinates, geographically centered
    end
    ...
    specify 'Make clusters smaller' do
      ...
      clusters.should eq [{:coordinates => [52.50941559999999, 13.453396199999998], :count => 2, :geohash => 'u33d'}, {:coordinates => [52.3941887, 13.072691000000003], :count => 1, :geohash => 'u336'}] # Two clusters, only two coordinates are close enough to be merged
    end
